          ...
          <form method="post">
            <div class="row">
                <div class="mbr-section col-md-10">
                    ...
                    <p class="mbr-section-lead lead">Type in the name or id of your desired pokemon and see its pokedex entry<br>Searching pokemon who are not yet searched for could take a while so be patient<br><br></p>
                    <input type="text" name="tbInputPokemon" id="tbInputPokemon" value="bulbasaur"><br><br>
